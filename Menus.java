...
public class Menus{
   ...
   private void menuListaS(){
     ...
     System.out.println("5. conocer el tamano de la lista");
     ...
     switch (opc1) {
       ...
       break;
       case "5":
        System.out.println("El tamano de su lista es de: ");
   ...
   public void menuListaDoble(){
     ...
     System.out.println("2. obtener un valor de la lista en la posicion indicada");
     System.out.println("3. remover elemento en la posición indicada");
     System.out.println("4. conocer el tamano de la lista");
   ...
   public void menuCola(){
     ...
     switch (opc3) {
       ...
       break;
       case "5":
         System.out.println("el tamano de la cola es: ");
   ...
   public void menuArbol(){
     ...
     switch (opc4) {
       case "1":
       System.out.println("escriba el dato a ingresar al arbol");
